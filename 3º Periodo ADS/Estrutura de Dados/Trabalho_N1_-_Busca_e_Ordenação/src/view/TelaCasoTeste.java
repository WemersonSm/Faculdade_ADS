 ...
 * @author Sam Gatoo
 */
public class TelaCasoTeste extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vamos ver qual o mais rápido");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        switch (pais) {
            case 1: {
                ...
                vetor.selectionSort(port.getDicionarioPortugueseBrazilian());
                ...
                port.LerPortugueseBrazilian();
                vetor.insertionSort(port.getDicionarioPortugueseBrazilian());
                port.GravarPortugueseBrazilianOrdenado();
                ...
                port.LerPortugueseBrazilian();
                port.setDicionarioPortugueseBrazilian(vetor.QuickSort(port.getDicionarioPortugueseBrazilian(), port.getDicionarioPortugueseBrazilian().length));
                port.GravarPortugueseBrazilianOrdenado();
            ...
            case 2: {
                ...
                vetor.selectionSort(eng.getDicionarioOriginalEnglishAmerican());
                ...
                long start2 = System.currentTimeMillis();
                eng.LerEnglishAmerican();
                vetor.insertionSort(eng.getDicionarioOriginalEnglishAmerican());
                eng.GravarEnglishAmericanOrdenado();
                long finish2 = System.currentTimeMillis();
                float total2 = finish2 - start2;
                total2 = total2 / 1000;
                ...
                long start3 = System.currentTimeMillis();
                eng.LerEnglishAmerican();
                eng.setDicionarioOriginalEnglishAmerican(vetor.QuickSort(eng.getDicionarioOriginalEnglishAmerican(), eng.getDicionarioOriginalEnglishAmerican().length));
                eng.GravarEnglishAmericanOrdenado();
                long finish3 = System.currentTimeMillis();
                float total3 = finish3 - start3;
                total3 = total3 / 1000;
            ...
            case 3: {
                ...
                span.LerSpanish();
                vetor.selectionSort(span.getDicionarioOriginalSpanish());
                ...
                long start2 = System.currentTimeMillis();
                span.LerSpanish();
                vetor.insertionSort(span.getDicionarioOriginalSpanish());
                span.GravarSpanishOrdenado();
                long finish2 = System.currentTimeMillis();
                float total2 = finish2 - start2;
                total2 = total2 / 1000;
                ...
                long start3 = System.currentTimeMillis();
                span.LerSpanish();
                span.setDicionarioOriginalSpanish(vetor.QuickSort(span.getDicionarioOriginalSpanish(), span.getDicionarioOriginalSpanish().length));
                span.GravarSpanishOrdenado();
                long finish3 = System.currentTimeMillis();
                float total3 = finish3 - start3;
                total3 = total3 / 1000;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCasoTeste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCasoTeste().setVisible(true);
            }
        });
    }
