...
public class TelaOrdenacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Escolha uma ordenação");
    ...
    private void jButtonMergeSortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMergeSortActionPerformed
        ...
        switch (pais) {
            case 1: {
                ...
                jTextFieldResultadoMerge.setText("O Merge sort demorou " + total + " - Segundos");
                break;
            }
            case 2: {
                long start = System.currentTimeMillis();
    ...
    private void jButtonQuickSortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonQuickSortActionPerformed
        ...
        switch (pais) {
            case 1: {
                ...
                jTextFieldResultadoQuick.setText("O Quick sort demorou " + total + " - Segundos");
                break;
            ...
            case 2: {
                ...
                DicionarioEnglishAmerican eng = new DicionarioEnglishAmerican();
                eng.LerEnglishAmerican();
                eng.setDicionarioOriginalEnglishAmerican(vetor.QuickSort(eng.getDicionarioOriginalEnglishAmerican(),
                        eng.getDicionarioOriginalEnglishAmerican().length));
                long finish = System.currentTimeMillis();
                float total = finish - start;
                total = total / 1000;
                eng.GravarEnglishAmericanOrdenado();
    ...
    private void jButtonInsertionSortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInsertionSortActionPerformed
        ...
        switch (pais) {
            case 1: {
                ...
                jTextFieldResultadoInsertion.setText("O Insertion sort portugues demorou " + total + " - Segundos");
                break;
            }
            case 2: {
                long start = System.currentTimeMillis();
                ...
                jTextFieldResultadoInsertion.setText("O Insertion sort inglês demorou " + total + " - Segundos");
                break;
            }
            case 3: {
                long start = System.currentTimeMillis();
                ...
                jTextFieldResultadoInsertion.setText("O Insertion sort demorou " + total + " - Segundos");
                break;
            }
            default: {
